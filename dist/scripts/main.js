...
function displayTime() {
  ...
  ;(s.innerHTML = t), (d.innerHTML = a + ' ' + c), (m.innerHTML =
    i[o] + ' ' + n + ' ' + r)
}
var unit = 'metric',
  preLoaderFlag = !1,
      ...
      $.ajax({
        ...
        success: function(e) {
          ...
          e.list.forEach(function(e, a) {
            ...
            ;(i.className =
              'pure-u-1 pure-u-md-4-24 day'), (s.className = 'date-forecast forecast--span'), (n.className = 'tempature-forecast forecast--span'), (d.className = 'description-forecast forecast--span'), (n.id = 'tempatureSpan' + a)
            var m = moment.unix(e.dt).format('dddd, DD MMM'),
              o = e.temp.max,
              r = e.temp.min,
              l = e.weather[0].description
            ;(s.innerHTML = m), (n.innerHTML = o + ' &deg;C / ' + r + ' &deg;C'), (d.innerHTML = l), i.appendChild(s), i.appendChild(n), i.appendChild(d), t.appendChild(i), c.appendChild(t)
          })
        }
      })
    }
  ...
  view = {
    ...
    getIcon: function(e) {
      var t = document.getElementById('icon-img')
      switch (e.weather[0].icon) {
        case '01d':
        case '01n':
          t.src = '../images/clear.svg'
          break
        case '02d':
        case '02n':
          t.src = '../images/mostlysunny.svg'
          break
        case '03d':
        case '03n':
          t.src = '../images/partlysunny.svg'
          break
        case '04d':
        case '04n':
          t.src = '../images/cloudy.svg'
          break
        case '09d':
        case '09n':
          t.src = '../images/rain.svg'
          break
        case '10d':
        case '10n':
          t.src = '../images/chancerain.svg'
          break
        case '11d':
        case '11n':
          t.src = '../images/tstorms.svg'
          break
        case '13d':
        case '13n':
          t.src = '../images/chancesnow.svg'
          break
        case '50d':
        case '50n':
          t.src = '../images/fog.svg'
          break
        default:
          t.src = '../images/unknown.svg'
      }
    },
