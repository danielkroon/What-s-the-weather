window.Modernizr = (function(e, t, n) {
  ...
  var l,
      ...
      if (parseInt(r, 10))
        for (; r--; )
          (c = t.createElement('div')), (c.id = o
            ? o[r]
            : p + (r + 1)), u.appendChild(c)
      return (a = ['&#173;', '<style id="s', p, '">', e, '</style>'].join(
        ''
      )), (u.id = p), ((l ? u : d).innerHTML += a), d.appendChild(u), l ||
        (
          (d.style.background = ''),
        ...
        : (d.parentNode.removeChild(d), (m.style.overflow = s)), !!i
    },
    $ = function(t) {
    ...
    F = {}.hasOwnProperty
  ;(d =
    a(F, 'undefined') || a(F.call, 'undefined')
      ? function(e, t) {
    ...
    return r(
      (e +
        ...
        E.join('linear-gradient(left top,#9f9, white);' + e)).slice(
        0,
        -e.length
      )
    ...
    var e
    return j('@font-face {font-family:"font";src:url("https://")}', function(
      n,
      r
    ) {
    ...
    return (e.innerHTML = '<svg/>'), (e.firstChild &&
      e.firstChild.namespaceURI) == C.svg
  }), (k.smil = function() {
    return (
      !!t.createElementNS &&
      /SVGAnimate/.test(b.call(t.createElementNS(C.svg, 'animate')))
    )
  }), (k.svgclippaths = function() {
    return (
      !!t.createElementNS &&
      /SVGClipPath/.test(b.call(t.createElementNS(C.svg, 'clipPath')))
    )
  })
  for (var z in k)
    d(k, z) &&
      ((l = z.toLowerCase()), (f[l] = k[z]()), M.push((f[l] ? '' : 'no-') + l))
  return f.input ||
    (function() {
      ;(f.input = (function(n) {
        ...
        for (var r, o, a, i = 0, c = e.length; i < c; i++)
          v.setAttribute('type', (o = e[i])), (r = 'text' !== v.type), r &&
            (
              (v.value = y),
    ...
    if ('object' == typeof e) for (var r in e) d(e, r) && f.addTest(r, e[r])
      ...
      ;(t = 'function' == typeof t ? t() : t), (m.className +=
        ' ' + (t ? '' : 'no-') + e), (f[e] = t)
    }
    return f
    ...
    function a(e, n, r) {
      ...
      return (a = r.cache[e]
        ...
        : m.test(e)
          ...
          : r.createElem(e)), !a.canHaveChildren || f.test(e) || a.tagUrn
        ? a
    ...
    function i(e, n) {
      ...
      n = n || o(e)
      for (var a = n.frag.cloneNode(), i = 0, c = r(), s = c.length; i < s; i++)
        a.createElement(c[i])
      return a
    }
    function c(e, t) {
    ...
    '2.8.3'), (f._prefixes = E), (f._domPrefixes = S), (f._cssomPrefixes = w), (f.mq = $), (f.hasEvent = D), (f.testProp = function(
    e
  ) {
    return c([e])
  }), (f.testAllProps = u), (f.testStyles = j), (f.prefixed = function(
    e,
    t,
    n
  ) {
    ...
    m.className.replace(/(^|\s)no-js(\s|$)/, '$1$2') + ' js ' + M.join(' ')), f
})(this, this.document)
