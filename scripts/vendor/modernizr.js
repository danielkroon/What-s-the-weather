window.Modernizr = (function(e, t, n) {
    ...
    j = function(e, n, r, o) {
      ...
      return (
        ...
        l
          ...
          : (d.parentNode.removeChild(d), (m.style.overflow = s)),
        !!i
      )
    },
    $ = function(t) {
      ...
      var r
      return (
        j('@media ' + t + ' { #' + p + ' { position: absolute; } }', function(
          t
        ) {
          r =
            'absolute' ==
  ...
  return (
    ...
    (m.className =
      m.className.replace(/(^|\s)no-js(\s|$)/, '$1$2') + ' js ' + M.join(' ')),
    f
  )
})(this, this.document)
