...
var model = {
  ...
  getWeatherByCity: function getWeatherByCity(cityInputValue) {
  ...
  getWeather: function getWeather(latitude, longitude, unit) {
    var keyWeather = 'c77539be6727a262645abebe5edee96c'
    var weather =
  ...
  getWeatherAjaxCall: function getWeatherAjaxCall(weather) {
    $.ajax({
      url: weather,
      dataType: 'jsonp',
  ...
  getForecastByCity: function getForecastByCity(cityInputValue) {
  ...
  getForecast: function getForecast(latitude, longitude, unit) {
    var keyForecast = '36b9b3713724a3a85221616772b7af78'
    var forecast =
  ...
  getForecastAjaxCall: function getForecastAjaxCall(forecast) {
    $.ajax({
      url: forecast,
      dataType: 'jsonp',
      success: function success(data) {
...
var view = {
  showWeather: function showWeather(tempature, description, city) {
  ...
  changeBackground: function changeBackground(data) {
